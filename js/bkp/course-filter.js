...
var searchform = unisearch.find("form");
//$(".widget-area").removeClass("col-md-3");
if ( '#main'.hasClass('universities') ){
    $("#coursesform").show();
$("#universitiesform").hide();
}
else if ( '#main'.hasClass('courses') ){
    $("#universitiesform").show();
	$("#coursesform").hide();
} 

 $("#coursestoggle").click(function(){
  $("#coursesform").show();
  $("#universitiesform").hide();
}); 
  $("#universitiestoggle").click(function(){
  $("#universitiesform").show();
  $("#coursesform").hide();
}); 
